...
async def fill_custom_questions(page, app: dict) -> None:
    ...
    if "lever.co" in url and "mistral" in url.lower():
        ...
        product_exp = (
            "Built an AI-augmented program management system from scratch - "
            "6 LLMs orchestrated through 4 enterprise APIs. "
            "B2B internal tooling, enterprise-grade, "
            "built for a post-M&A environment with no existing infrastructure.\n\n"
            "Shipped consumer hardware product from "
            "sensor research to high-volume production. B2C hardware, 10 teams, 5 countries, "

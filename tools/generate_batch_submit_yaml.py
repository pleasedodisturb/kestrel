...
HOOKS = yaml.safe_load((ROOT / "cv" / "applications" / "_batch-templates" / "hooks.yaml").read_text())
...
out_path.write_text(yaml.dump(output, default_flow_style=False, allow_unicode=True, sort_keys=False))

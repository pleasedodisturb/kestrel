...
def upgrade() -> None:
    ...
    with op.batch_alter_table('calendar_events', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_calendar_events_parent_event_id'), ['parent_event_id'], unique=False)
        batch_op.create_foreign_key(
            'fk_calendar_events_parent_event_id', 'calendar_events', ['parent_event_id'], ['id'],
            ondelete='CASCADE'
        )

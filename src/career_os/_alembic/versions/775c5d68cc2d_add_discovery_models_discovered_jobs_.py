...
def upgrade() -> None:
    ...
    with op.batch_alter_table("search_profiles", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_search_profiles_profile_id"), ["profile_id"], unique=False
        )
    ...
    with op.batch_alter_table("discovered_jobs", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_discovered_jobs_company_normalized"),
            ["company_normalized"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_discovered_jobs_location_normalized"),
            ["location_normalized"],
            unique=False,
        )
        batch_op.create_index(
            batch_op.f("ix_discovered_jobs_profile_id"), ["profile_id"], unique=False
        )
        batch_op.create_index(
            batch_op.f("ix_discovered_jobs_title_normalized"), ["title_normalized"], unique=False
        )
    ...
    with op.batch_alter_table("discovery_runs", schema=None) as batch_op:
        batch_op.create_index(
            batch_op.f("ix_discovery_runs_profile_id"), ["profile_id"], unique=False
        )
